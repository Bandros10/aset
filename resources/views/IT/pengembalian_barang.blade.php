...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Pengembalian Perangkat</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                        <li class="breadcrumb-item"><a href="{{route('it.pengembalian')}}"></a>Pengembalian</li>
                        <li class="breadcrumb-item active"></a>Pengembalian Perangkat</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col">
                    <x-card>
                        ...
                        <form action="{{route('it.pengembalian_submit',$data_pengembalian->id)}}" method="POST">
                            ...
                            <br>
                            <button type="submit" class="btn btn-block btn-info">Submit Pengambalian Perangkat</button>
                        </form>
                        @slot('footer')
